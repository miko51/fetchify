...
export default function BillingPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Portal Card */}
      <div className="card-modern bg-gradient-to-br from-blue-500/10 to-violet-500/10 border-blue-500/20">
        <div className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-white mb-2">Portail de facturation Stripe</h3>
              <p className="text-slate-300 text-sm mb-4">
                Accédez au portail Stripe pour gérer vos moyens de paiement, télécharger vos factures
                et mettre à jour vos informations de facturation.
              </p>
              <button
                onClick={openCustomerPortal}
                disabled={loadingPortal}
